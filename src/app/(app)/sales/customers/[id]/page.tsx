    ...
    <div className="px-6 py-5">
      ...
      <div className="flex border-b border-slate-200 mb-3">
        {(['details', 'related', 'activity', 'artwork', 'specs'] as const).map((tab) => (
          ...
          >
            {tab}
            {tab === 'related' && customer.contacts.length + customer.opportunities.length + customer.files.length + customer.tasks.length > 0 && (
      ...
      {activeTab === 'related' && (
        <div className="grid gap-4 md:grid-cols-3 items-start">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden">
            <div className="flex items-center justify-between px-5 py-3 border-b border-slate-100 bg-slate-50">
              <h2 className="text-sm font-semibold text-slate-700">Open Tasks ({customer.tasks.length})</h2>
            ...
            {customer.tasks.length === 0
              ? <div className="px-5 py-5 text-sm text-slate-400 text-center">No open tasks linked to this customer.</div>
