...
function DocumentRow({
  ...
  return (
    <tr className={isHighlighted ? 'highlighted' : ''}>
      <td>
        <button className="doc-link" onClick={handleOpen} disabled={fetching} style={{ background: 'none', border: 'none', padding: 0, textAlign: 'left' }}>
          {isUploaded ? (
      ...
      <td className="actions-cell">
        <div ref={menuRef} style={{ position: 'relative', display: 'inline-block' }}>
          <button className="actions-menu-btn" onClick={() => setMenuOpen(o => !o)} title="Actions">
            •••
          </button>
          {menuOpen && (
